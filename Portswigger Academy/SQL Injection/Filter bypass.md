...
Lessons learnt:
- character 'a' converts to '97' eg. `ord('a')`
- html hex encoding of 'a' is '&#97;' we can do this by using this format string `''.join('&#{};'.format(ord(s)) for s in payload)`
...
![](screens/sqli%20with%20filter%20bypass%20XML%20encoding.png)